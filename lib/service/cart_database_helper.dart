...
import 'package:costacoffe/constant/constance.dart';
...
class CartDataBaseHelper{
  ...
  Future <List<CartModel>> getAllProdcut() async{
    var dbClient=await database;
    List<Map>maps=await dbClient!.query(tableCartProduct);
    List<CartModel>list=maps.isNotEmpty?maps.map((prodcuts) => CartModel.fromJson(prodcuts)).toList():[];
    return list;
  }
